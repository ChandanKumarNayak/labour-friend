...
<head>
  ...
  <title>Forgot Password | LabourFriend</title>
...
$getdata = ("SELECT password FROM outside WHERE email = '".$_POST["email"]."'");
if($result = mysqli_query($db, $getdata))
if(mysqli_num_rows($result) >0)
while($row = mysqli_fetch_array($result))
{
     $mailto = $_POST["email"];
	 $mailSub = 'LabourFriend-Your Password';
     $mailMsg ="Password:- ". $row['password'];
