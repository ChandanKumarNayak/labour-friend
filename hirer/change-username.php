...
{echo '<script language="javascript">alert("Current username is wrong.");</script>';}
 ...
 $username_2 = $_POST['username_2'];
  ...
  $sqluser="SELECT hirer_username FROM outside WHERE hirer_username='$username_2' ";
  $qresult=mysqli_query($db, $sqluser);
  $count=mysqli_num_rows($qresult);
  if($count > 0)
  {
...
$sql="UPDATE `outside` SET hirer_username='$username_2' WHERE hirer_username='".$_SESSION['hirer_username']."' AND hirer_username = '$username_1'";
