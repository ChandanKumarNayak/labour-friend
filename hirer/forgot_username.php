...
<head>
  ...
  <title>Forgot Username | LabourFriend</title>
				...
				<div class="d-flex justify-content-center form_container">
					<form method="post" action="">
						<div class="input-group mb-3">
							...
							<input type="email" name="email" placeholder="Registered Email ID" required>
							</div>
						<div class="d-flex justify-content-center mt-3 login_container">
						<button class="btn login_btn" type="submit" name="send">
							Send Email
						</button>
				</div>
				<br>
				<p style="color:white">Click to <a href="hirer_login.php" style="color:yellow">Sign In</a> </p>
					</form>
				</div>
			</div>
		</div>
...
$getdata = ("SELECT hirer_username FROM outside WHERE email = '".$_POST["email"]."'");
if($result = mysqli_query($db, $getdata))
if(mysqli_num_rows($result) >0)
while($row = mysqli_fetch_array($result))
{
     $mailto = $_POST["email"];
	 $mailSub = 'LabourFriend-Your Username';
     $mailMsg ="Username:- ". $row['hirer_username'];
   ...
   $mail ->IsHTML(true);
   $mail ->Username = "labourfriend134@gmail.com";
   $mail ->Password = "1872247398";
   $mail ->SetFrom("labourfriend134@gmail.com","LabourFriend");
