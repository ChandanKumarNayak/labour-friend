...
<html>
<head>
  <title>Hirer Signup | LabourFriend</title>
<meta charset="utf-8">
			...
			<div class="user_card">
				...
				<form method="post" action="">
						<div class="input-group mb-3">
							...
							<input type="text" name="name" pattern="^[a-zA-Z\s]+$" class="form-control input_user" placeholder="Enter full name" required>
						</div>
						<div class="input-group mb-3">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-mobile"></i></span>
							</div>
							<input type="tel" name="phone" maxlength="10" pattern="^[6789]\d{9}$" class="form-control input_user" placeholder="Enter mobile number" required>
						</div>
							<div class="input-group mb-3">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-box"></i></span>
							</div>
							<input type="email" name="signup_email" class="form-control input_user" placeholder="Enter a email id" required>
						</div>
						<div class="input-group mb-3">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-user"></i></span>
							</div>
							<input type="text" name="hirer_username" class="form-control input_user" placeholder="Enter a username" required>
						</div>
						<div class="input-group mb-2">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-key"></i></span>
							</div>
							<input type="text" name="password" class="form-control input_pass" placeholder="Enter a password" required>
						</div>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links" style="color:white";>
						Already have an account? <a href="hirer_login.php" class="ml-2" style="color:blue">Sign In</a>
					</div>
...
$signup_email = $_POST['signup_email'];
 ...
 $password = $_POST['password'];
  if($count == 0)
	   $query= "INSERT INTO outside (name,phone,signup_email,hirer_username,password,myimage,purpose,amount,email,pid,status) VALUES ('$name','$phone','$signup_email','$hirer_username','$password','0','0','0','0','0','0')";
  	
  if($result = mysqli_query($db, $query))
    if(($result) > 0)
  	 echo '<script language="javascript">alert("Signed up successfully.");</script>';
  	echo '<meta http-equiv="refresh" content="0;hirer_login.php" />';
