...
th{ padding: 20px 20px 20px 20px;} td{ padding: 20px 20px 20px 20px;} 
</style>
<script type="text/javascript">
function did1(id)
{
     if(confirm('Sure To Delete Your Account From LabourFriend ?'))
     {
        window.location.href='delete-account.php?did1='+id;
     }
}
</script>
</head> 
...
?>	
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">		
		...
		<ul class="nav navbar-nav navbar-right ml-auto">
			...
			<li class="nav-item"><a href="delete-account.php?logout='1'" class="nav-link"><i class="material-icons">&#xE8AC;</i><span>Logout</span></a></li>
				</ul>
			</li>
		</ul>
	</div>
...
if(isset($_GET['did1'])) // Get Id
{
$did1=$_GET['did1'];
$sql="DELETE FROM daily_labour WHERE id='$did1'";	
if($result = mysqli_query($db, $sql)){
   

$msg="Account Deleted Successfully "; // Success Message

}
}
?>

<!-- Manage Labour Details  -->

<table>
<tr>
<th>Your account will be deleted permanently & you will no longer be able to access your "LabourFriend" account by using your current username & password.
						</th>
</tr>
<?php
include('db.php');
...
?>
<tr>
<td align="center"><a href="javascript:did1(<?php echo $row[0]; ?>)"><button class="btn"><img border="0" alt="chandan" src="../image/del.jpg" width="30" height="30" align="center"></button></a></td>
</tr>
<?php
