...
<title>Retrive Password | LabourFriend</title>
...
$getdata = ("SELECT password FROM daily_labour WHERE labour_username = '$labour_username' AND phone = '$phone'");
		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					...
					<center><h1 style="color:white">Password</h1></center><br>
						<div class="input-group mb-1">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-key"></i></span>
							</div>
							<input type="text" name="password" class="form-control input_user" value="<?php echo $row['password']; ?>" readonly>
						</div>
						<?php	}
	?>
						</form>
