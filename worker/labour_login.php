...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
     <meta name="description" content="Make Your Status ON and OFF According To Your Availability.Edit Details And Change Username & Password.">
  ...
  <title>Labour Signin | LabourFriend</title>
			...
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form method="post" action="">
						<div class="input-group mb-3">
							...
							<input type="text" name="labour_username" class="form-control input_user" placeholder="username" required>
						</div>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links" style="color:white">
						Don't have an account? <a href="labour_register.php" class="ml-2" style="color:yellow">Sign Up</a>
					</div>
