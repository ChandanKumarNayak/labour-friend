		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form method="post" action="retrive_username.php">
						...
						<div class="input-group mb-2">
							...
							<input type="tel" name="phone" class="form-control input_pass" placeholder="Registered Mobile No." required>
						</div>
						<div class="d-flex justify-content-center mt-3 login_container">
					<button type="submit" name="find" class="btn login_btn">Find</button>
				</div>
					</form>
				</div>
			</div>
