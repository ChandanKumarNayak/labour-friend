...
{echo '<script language="javascript">alert("Current username is wrong.");</script>';}
  ...
  $sqluser="SELECT password FROM daily_labour WHERE password='$password_1' ";
  $qresult=mysqli_query($db, $sqluser);
  $count=mysqli_num_rows($qresult);
   if($count == 0)
...
$sql="UPDATE `daily_labour` SET password='$password_3' WHERE labour_username='$username_1' AND password = '$password_1'";	
